...
import { Building2, UserCog, Calendar, HelpCircle as QuestionIcon, BarChart3, Settings, TestTube, Edit3, Database } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 max-w-4xl mx-auto shadow-lg border border-white/20 mb-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed text-center">
            Utilisez les sections ci-dessous pour gérer tous les aspects de votre plateforme de questionnaires. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          >
            <div className="text-center">
              <div className="w-20 h-20 bg-cyan-100 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-cyan-200 transition-colors">
                <Database className="w-10 h-10 text-cyan-600" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-3">Base de Données</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Visualiser et gérer les données de la plateforme
              </p>
            </div>
          </Link>
        </div>
